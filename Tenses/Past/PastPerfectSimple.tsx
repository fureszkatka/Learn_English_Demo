...
import styles from "./Styles/PastPerfectSimple_style";
import { TextInput } from "react-native";
import { ScrollView } from "react-native-gesture-handler";


interface PastPerfectSimpleState {
    sentences : Array<{sample: string, text: string, isRight: boolean }>,
}

export default class PastPerfectSimple extends Component<PastPerfectSimpleState> {
    state = {
        sentences: [
            {
                sample: "is doing",
