...
import styles from "./Styles/PresentContinuous_style";
import { TextInput } from "react-native";
import { ScrollView } from "react-native-gesture-handler";
import { TouchableOpacity } from "react-native";


interface PresentContinuousState {
    sentences : Array<{sample: string, text: string, isRight: boolean }>,
    checking: boolean,
    refreshing: boolean
}

export default class PresentContinuous extends Component<PresentContinuousState> {
    state = {
        sentences: [
            {
                sample: "is doing",
